# Generated by Django 5.1.2 on 2024-11-30 15:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('est_published', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('activite', 'affirmation')},
            },
        ),
        migrations.AddField(
            model_name='activite',
            name='affirmations',
            field=models.ManyToManyField(through='api.ActiviteAffirmation', to='api.affirmation'),
        ),
        migrations.CreateModel(
            name='Question',
            fields=[
                ...
                ('created_by', models.ForeignKey(limit_choices_to={'role': 'encadrant'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activite_affirmation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.activiteaffirmation')),
